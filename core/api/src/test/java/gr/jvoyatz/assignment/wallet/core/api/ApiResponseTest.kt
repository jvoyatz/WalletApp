...
import gr.jvoyatz.assignment.wallet.core.api.config.response.getOrNull
...
import gr.jvoyatz.assignment.wallet.core.api.config.response.onHttpError
import gr.jvoyatz.assignment.wallet.core.api.config.response.onNetworkError
import gr.jvoyatz.assignment.wallet.core.api.config.response.onSuccess
import gr.jvoyatz.assignment.wallet.core.api.config.response.onSuspendedError
import gr.jvoyatz.assignment.wallet.core.api.config.response.onSuspendedHttpError
import gr.jvoyatz.assignment.wallet.core.api.config.response.onSuspendedNetworkError
import gr.jvoyatz.assignment.wallet.core.api.config.response.onSuspendedSuccess
import gr.jvoyatz.assignment.wallet.core.api.config.response.onSuspendedUnknownError
import gr.jvoyatz.assignment.wallet.core.api.config.response.onUnknownError
import gr.jvoyatz.assignment.wallet.core.api.config.response.toFlow
import gr.jvoyatz.assignment.wallet.core.api.config.response.toSuspendFlow
